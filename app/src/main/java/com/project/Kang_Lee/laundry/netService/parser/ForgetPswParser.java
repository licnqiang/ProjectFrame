 ...
 */
public class ForgetPswParser extends BaseParser {

    private BaseReseponseInfo baseReseponseInfo=new BaseReseponseInfo();

    private String url = UrlContant.forget_psw;


    private NetControl.GetResultListenerCallback listener;

    public ForgetPswParser(NetControl.GetResultListenerCallback listener, HashMap<String, String> mHashMap) {
