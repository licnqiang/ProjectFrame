...
import com.example.administrator.laundry.adapter.ImagePickerAdapter;
...
public class SelectImageFragment extends BaseFragment {
    ...
    public void setActivity(Activity homeActivity) {
    ...
    private ImagePickerAdapter.OnRecyclerViewItemClickListener onRecyclerViewItemClickListener=new ImagePickerAdapter.OnRecyclerViewItemClickListener() {
        @Override
    ...
    public List<String> getSelectImg(){
        ...
        if (selImageList!=null&&selImageList.size()>0){
            for (int i=0;i<selImageList.size();i++){
                imglist.add(selImageList.get(i).path);
            }
        }
        return imglist;
    }
