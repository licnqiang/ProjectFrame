 ...
 */
public class CreatMessageParser extends BaseParser {
    ...
    public CreatMessageParser(NetControl.GetResultListenerCallback listener, HashMap<String, String> mHashMap) {
