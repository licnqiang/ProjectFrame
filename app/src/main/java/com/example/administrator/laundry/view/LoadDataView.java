...
//    private BKToolbar bkToolbar;
    ...
    public LoadDataView(Context context, View view) {
        ...
        loadingTv =loadingView.findViewById(R.id.loadingTv); //加载中提示
...
//            loadingEmptyTv.setVisibility(View.GONE);
    ...
    public void setLoadingTv(String loadingTxt) {
        if (loadingTv!=null){
        ...
        /*  public BKToolbar getLoadToolBar(){
        return bkToolbar;
    }

    public void setLoadToolBar(String value){
        if (bkToolbar!=null){
            bkToolbar.getTvTitle().setText(value);
        }
    }*/
}
